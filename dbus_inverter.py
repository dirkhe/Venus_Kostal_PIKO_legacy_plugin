...
class DbusInverter:
    ...
    def __init__(self, name, connection, device_instance, serial, product_name, firmware_version, process_version,
        ...
        self.dbusservice.add_path('/stats/last_time', 0, gettextcallback=_x)
